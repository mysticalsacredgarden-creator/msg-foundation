...
msg-foundation is an internal team operations dashboard where members log work items, track statuses, and share a live view — replacing spreadsheets and chat for daily workflow management.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "288953655+mysticalsacredgarden-creator@users.noreply.github.com"
  git config user.name "mysticalsacredgarden-creator"
  ```
